...
dependencies {
    ...
    intellijPlatform {
        ...
        // No bundledPlugin(...) needed -- .env files are parsed as
        // plain KEY=VALUE text, never PSI, so this works whether or
        // not the platform's own ".env files" plugin is installed.
